...
import logo from "../../assets/logo-nusu.jpeg";
...
const Header = () => {
  ...
  const navItems = [
    ...
    { name: "소개", path: "/about" },
    { name: "블로그", path: "https://m.blog.naver.com/wow1565?tab=1", isExternal: true },
          ...
          {navItems.map((item) => (
            item.isExternal ? (
              <a
                ...
                className="text-gray-300 hover:text-blue-500 transition-colors cursor-pointer font-medium"
              >
                {item.name}
              </a>
            ) : (
