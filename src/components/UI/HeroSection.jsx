        ...
        <div className="flex items-center justify-center">
          <div className={`space-y-6 transform transition-all duration-1000 text-center ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
            <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-white">
              최고의 기술력<br />
              <span className="text-blue-500">누수 탐지</span> 및 <span className="text-blue-500">공사</span><br />
              전문 업체
            </h1>
            ...
            <div className="flex justify-center space-x-4">
              <Link to="/contact">
                <button className="bg-blue-500 text-gray-900 px-8 py-3 font-semibold hover:bg-blue-400 transition-colors whitespace-nowrap cursor-pointer rounded">
                  무료 상담 예약
                </button>
              </Link>
            </div>
